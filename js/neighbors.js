...
(function($) {
    const url = {
        fetch_neighbors: 'include/neighbor_process.php',
    ...
    var show_neighbors_page = {
        ...
        generate_neighbor_table: function(json_data) {
            ...
            for(var i = 0; i < json_data["length"]; ++i) {
                var table_row =
                    ...
                    "                    <td><button type=\"button\" class=\"btn btn-primary\" data-mid = "+json_data[i]["uid"]+ ">Add</button></td>\n" +
                    "                   </tr>";
        ...
        send_add_friend_request(send_request_url) {
            $('#neighbor_table').delegate('.btn-primary', 'click', function(){
